...
`AgentClient` is framework-agnostic — use it with Vue, Svelte, Web Components, or plain DOM APIs. See the [Client Guide](/docs/client#vanilla-typescript-no-react) for the full API.
...
| Example | Description |
|---------|-------------|
| [basic-chat](https://github.com/quantumleeps/neeter/tree/main/examples/basic-chat) | Minimal React chat UI — `AgentProvider` + `MessageList` + `ChatInput` |
| [vanilla-chat](https://github.com/quantumleeps/neeter/tree/main/examples/vanilla-chat) | Same chat UI using `@neeter/core` directly — no React, plain TypeScript + DOM APIs |

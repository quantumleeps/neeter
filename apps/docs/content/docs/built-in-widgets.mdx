...
Source files: [`packages/react/src/widgets/*Widget.tsx`](https://github.com/quantumleeps/neeter/tree/main/packages/react/src/widgets) | Registry: [`packages/core/src/registry.ts`](https://github.com/quantumleeps/neeter/tree/main/packages/core/src/registry.ts)
